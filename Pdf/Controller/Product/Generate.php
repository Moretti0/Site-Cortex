...
class Generate extends Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $pdfContent = $this->pdfGenerator->generate($product, $template);
            $fileName = sprintf('%s_%s.pdf', $product->getSku(), $template);
            $filePath = $this->pdfGenerator->savePdf($pdfContent, $fileName);

            return $result->setData([
                'success' => true,
                'downloadUrl' => $this->getUrl('cortex_pdf/product/download', [
